...
fid=fopen(strcat('/DATA/234/sz_fmri/ALE_AH/WITH_GR/sample/AVH_match/',site{i},'_AH.txt'));
AH=textscan(fid,'%s');
AH=AH{1};
fclose(fid);

fid=fopen(strcat('/DATA/234/sz_fmri/ALE_AH/WITH_GR/sample/AVH_match/',site{i},'_NAH.txt'));
NAH=textscan(fid,'%s');
NAH=NAH{1};
fclose(fid);

fid=fopen(strcat('/DATA/234/sz_fmri/ALE_AH/WITH_GR/sample/AVH_match/',site{i},'_NC.txt'));
NC=textscan(fid,'%s');
NC=NC{1};
fclose(fid);
